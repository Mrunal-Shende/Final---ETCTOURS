...
const FloatingControls = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999] flex flex-col gap-2">
      ...
      {/* Inquiry Now */}
        <Link to="/enquery" className="w-8 h-8 md:w-10 md:h-10 rounded-full shadow-2xl hover:scale-110 transition-transform group flex items-center justify-center relative">
